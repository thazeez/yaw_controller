#!/usr/bin/env python3
# how to run:
# python3 offboard_vel_relay_body3_fullquat_withyaw_falcon.py --cmd-timeout 0.3 --offboard-prestream 0.8 --yawrate-max 1.0
...
class OffboardVelRelayBodyFullQuat(Node):
    def __init__(
        self,
        cmd_topic="/cmd_vel",
        odom_topic="/falcon/fmu/out/vehicle_odometry",
        offboard_mode_topic="/falcon/fmu/in/offboard_control_mode",
        traj_sp_topic="/falcon/fmu/in/trajectory_setpoint",
        vehicle_cmd_topic="/falcon/fmu/in/vehicle_command",
        hz=50.0,
        ...
        if not log_path:
            ...
            log_path = f"/home/root/logs/offboard_body_relay_fullquat_withyaw_falcon_{ts}_{run_id}.csv"
...
def main():
    ...
    parser.add_argument("--odom-topic", type=str, default="/falcon/fmu/out/vehicle_odometry")
    parser.add_argument("--offboard-mode-topic", type=str, default="/falcon/fmu/in/offboard_control_mode")
    parser.add_argument("--traj-sp-topic", type=str, default="/falcon/fmu/in/trajectory_setpoint")
    parser.add_argument("--vehicle-cmd-topic", type=str, default="/falcon/fmu/in/vehicle_command")
